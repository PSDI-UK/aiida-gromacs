...
Check version number in setup.json and aiida_gromacs/__init__.py and make sure
they match.
"""
...
import aiida_gromacs  # pylint: disable=wrong-import-position

VERSION = aiida_gromacs.__version__
