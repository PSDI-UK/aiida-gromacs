...
gmx_grompp -f MDstep_1.1_minimization.mdp -o MDstep_1.1_minimization.tpr -c MDstep_1.0_minimization.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
...
 gmx_grompp -f MDstep_1.2_equilibration.mdp -o MDstep_1.2_equilibration.tpr -c MDstep_1.1_minimization.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
...
gmx_grompp -f MDstep_1.3_equilibration.mdp -o MDstep_1.3_equilibration.tpr -c MDstep_1.2_equilibration.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
...
gmx_grompp -f MDstep_1.4_equilibration.mdp -o MDstep_1.4_equilibration.tpr -c MDstep_1.3_equilibration.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
...
gmx_grompp -f MDstep_1.5_equilibration.mdp -o MDstep_1.5_equilibration.tpr -c MDstep_1.4_equilibration.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
...
gmx_grompp -f MDstep_1.6_equilibration.mdp -o MDstep_1.6_equilibration.tpr -c MDstep_1.5_equilibration.gro -r solvated_insane.gro -p system.top -n index.ndx -maxwarn 1
